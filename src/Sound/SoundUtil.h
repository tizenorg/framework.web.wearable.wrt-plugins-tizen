...
const std::string AUDIO_JACK = "AUDIO_JACK";
const std::string BLUETOOTH = "BLUETOOTH";
const std::string HDMI = "HDMI";
const std::string MIRRORING = "MIRRORING";
const std::string USB_AUDIO = "USB_AUDIO";
...
public:
    ...
    static std::string soundDeviceTypeToString(sound_device_type_e soundDevice);
    static sound_device_type_e stringToSoundDeviceType(std::string soundDevice);

    static std::string soundIOTypeToString(sound_device_io_direction_e IOType);
    static sound_device_io_direction_e stringToSoundIOType(std::string IOType);
    ...
    template <class T = DeviceAPI::Common::UnknownException>
    static void throwSoundException(const std::string& hint) {
        LOGE("%s", hint.c_str());
        throw T(hint.c_str());
    }
