...
#ifndef __TIZEN_JS_BLUETOOTH_LESERVICE_DATA_H__
#define __TIZEN_JS_BLUETOOTH_LESERVICE_DATA_H__
...
class JSBluetoothLEServiceData
{
public:
    ...
    static BluetoothLEServiceData* getPrivateObject(JSContextRef context, JSObjectRef object);
    static void setPrivateObject(JSContextRef context, JSObjectRef object, BluetoothLEServiceData *priv);
private:
