...
#ifndef __TIZEN_JS_BLUETOOTH_LEMANUFACTURER_DATA_H__
#define __TIZEN_JS_BLUETOOTH_LEMANUFACTURER_DATA_H__
...
class JSBluetoothLEManufacturerData
{
public:
    ...
    static BluetoothLEManufacturerData* getPrivateObject(JSContextRef context, JSObjectRef object);
    static void setPrivateObject(JSContextRef context, JSObjectRef object, BluetoothLEManufacturerData *priv);
private:
