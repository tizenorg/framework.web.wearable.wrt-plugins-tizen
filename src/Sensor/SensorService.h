...
class HRMRawSuccessCallback : public Common::CallbackUserData
{
public:
    HRMRawSuccessCallback(JSContextRef globalCtx);
    virtual ~HRMRawSuccessCallback();
...
typedef std::shared_ptr<HRMRawSuccessCallback> HRMRawSuccessCallbackPtr;
...
struct HRMRawSuccessCallbackHolder {
    HRMRawSuccessCallbackPtr ptr;
    JSValueRef mJSHRMRawData;
};
...
public:
    HRMRawSensor();
    virtual ~HRMRawSensor();
    static HRMRawSensor* getInstance();
    void start(HRMRawSuccessCallbackPtr successCB);
    void stop(JSContextRef globalCtx);
    void setChangeListener(HRMRawSuccessCallbackPtr callback);
    void unsetChangeListener(JSContextRef globalCtx);
    void getSensorData(HRMRawSuccessCallbackPtr callback);
    void broadcast_HRMRaw(sensor_type_e type, float pressure);
    bool isSupported();
    void removeCallback(JSContextRef globalCtx);
    void convertHRMRawData(sensor_type_e type, unsigned long HRMRaw, HRMRawSuccessCallbackPtr callback);

    static void sensor_HRMRaw_callback(sensor_h sensor, sensor_event_s *event, void *user_data);
    static gboolean callHRMRawStartSuccessCallback(void* data);
    static gboolean callHRMRawSuccessCallback(void* data);

private:
    sensor_h mHRMRawGreenHandle;
    sensor_listener_h mHRMRawGreenListener;
    sensor_h mHRMRawRedHandle;
    sensor_listener_h mHRMRawRedListener;
    sensor_h mHRMRawIrHandle;
    sensor_listener_h mHRMRawIrListener;

    bool mBStart;
    bool mBSupported;
    bool mHRMSupported;
    bool mGreenSupported;
    bool mRedSupported;
    bool mIrSupported;
    std::map<JSContextRef, HRMRawSuccessCallbackPtr> mHRMRawCallbackMap;
    std::map<JSContextRef, bool> mHRMRawStartMap;
