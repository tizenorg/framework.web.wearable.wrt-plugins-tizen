...
const char* TIZEN_FEATURE_INPUT_ROTATING_BEZEL = "http://tizen.org/feature/input.rotating_bezel";
...
const char* TIZEN_FEATURE_NFC_CARD_EMULATION_HCE = "http://tizen.org/feature/network.nfc.card_emulation.hce";
const char* TIZEN_FEATURE_NFC_P2P = "http://tizen.org/feature/network.nfc.p2p";
const char* TIZEN_FEATURE_NFC_RESERVED_PUSH = "http://tizen.org/feature/network.nfc.reserved_push";
const char* TIZEN_FEATURE_NFC_TAG = "http://tizen.org/feature/network.nfc.tag";
...
const char* TIZEN_FEATURE_INTERNET = "http://tizen.org/feature/network.internet";
...
const char* TIZEN_FEATURE_SCREEN_SHAPE = "http://tizen.org/feature/screen.shape";
const char* TIZEN_FEATURE_SCREEN_SHAPE_CIRCLE = "http://tizen.org/feature/screen.shape.circle";
const char* TIZEN_FEATURE_SCREEN_SHAPE_RECTANGLE = "http://tizen.org/feature/screen.shape.rectangle";
