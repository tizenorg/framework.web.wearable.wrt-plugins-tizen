...
private:
    ...
    // to add a listener for network type
    void registerNetworkTypeChangeCallback();
    void unregisterNetworkTypeChangeCallback();
    static void onConnectionNetworkTypeChanged(connection_type_e type, void *user_data);

    void broadcastNetworkTypeChanged();
    ...
    //! to store the state of whether telephony is enable or not
    bool m_is_telephony_enable;
};
