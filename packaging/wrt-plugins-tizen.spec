...
# Bluetooth API is optional in Tizen Wearable Profile.
%ifarch %{arm}
# ARM
...
# Notification API is mandatory in Tizen Wearable Profile.
...
%endif
%if 0%{?tizen_feature_system_setting_incoming_call_screen_support}
-DENABLE_OPTIONAL_SYSTEM_SETTING_INCOMING_CALL=YES \
%endif
%if 0%{?tizen_feature_system_setting_notification_email_screen_support}
